...
infoname = ["Roshan","Raj","Rashad","Vismay"]; //These are the name of my roomates
balance = [350,0,0,0];
savings = [2000,300,34,110]
...
function Deposit() {
    ...
    document.getElementById("balance").innerHTML =prbalance;  
    document.getElementById("notification") .innerHTML= "Success. You deposited "+input+" Dollars on balance";
    }
}
